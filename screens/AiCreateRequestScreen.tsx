...
export default function AiCreateRequestScreen() {
  ...
  const publish = async () => {
    ...
    try {
      ...
      await clearClientDraft();
      const taskId = published.data.task_id;
      setResponse(null);
      setMessages([]);
        ...
        <View style={styles.composerArea}>
          ...
          {action?.type === "ask_question" && action.question.field_type === "photo" ? (
            <View style={styles.optionGrid}>
              <TouchableOpacity style={styles.photoButton} onPress={addPhoto} disabled={busy}><Ionicons name="image-outline" size={20} color={colors.textPrimary} /><Text style={styles.photoButtonText}>Добавить фото</Text></TouchableOpacity>
...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: colors.background }, loading: { flex: 1, alignItems: "center", justifyContent: "center" },
  header: { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: 10, gap: 12 },
  roundButton: { width: 42, height: 42, borderRadius: 21, backgroundColor: colors.surfaceSecondary, alignItems: "center", justifyContent: "center" },
  headerTitle: { flex: 1 }, eyebrow: { fontSize: 10, fontWeight: "600", color: colors.success, letterSpacing: 1 }, title: { fontSize: 18, fontWeight: "600", color: colors.textPrimary, marginTop: 2 }, stepLabel: { marginTop: 2, fontSize: 11, color: colors.textSecondary },
  progressTrack: { height: 3, backgroundColor: colors.surfacePressed }, progress: { height: 3, backgroundColor: colors.accentPressed },
  welcome: { flex: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: 30 }, spark: { width: 72, height: 72, borderRadius: 36, backgroundColor: colors.accentSoft, alignItems: "center", justifyContent: "center" },
  welcomeTitle: { fontSize: 24, lineHeight: 30, fontWeight: "600", color: colors.textPrimary, marginTop: 20 }, welcomeText: { fontSize: 15, lineHeight: 22, color: colors.textSecondary, textAlign: "center", marginTop: 10 },
  chat: { padding: 16, gap: 10, flexGrow: 1, justifyContent: "flex-end" }, bubble: { maxWidth: "86%", borderRadius: radius.lg, paddingHorizontal: 16, paddingVertical: 12 }, userBubble: { alignSelf: "flex-end", backgroundColor: colors.accentSoft, borderBottomRightRadius: 6 }, assistantBubble: { alignSelf: "flex-start", backgroundColor: colors.surfaceSecondary, borderBottomLeftRadius: 6 },
  userText: { color: colors.textPrimary, fontSize: 15, lineHeight: 21 }, assistantText: { color: colors.textPrimary, fontSize: 15, lineHeight: 21 },
  composerArea: { backgroundColor: colors.surface, borderTopLeftRadius: radius.xl, borderTopRightRadius: radius.xl, padding: 14, gap: 10 }, composer: { flexDirection: "row", alignItems: "flex-end", gap: 10 }, input: { flex: 1, maxHeight: 110, minHeight: 52, borderRadius: radius.lg, backgroundColor: colors.surfaceSecondary, paddingHorizontal: 16, paddingVertical: 14, fontSize: 16, color: colors.textPrimary }, send: { width: 48, height: 48, borderRadius: 24, backgroundColor: colors.accent, alignItems: "center", justifyContent: "center" }, sendDisabled: { opacity: 0.35 },
  chips: { gap: 8, paddingVertical: 2 }, chip: { borderRadius: radius.full, backgroundColor: colors.accentSoft, paddingHorizontal: 16, paddingVertical: 12 }, chipText: { fontSize: 14, fontWeight: "600", color: colors.textPrimary },
  optionGrid: { flexDirection: "row", flexWrap: "wrap", gap: 8 }, option: { minWidth: "47%", flexGrow: 1, borderWidth: 1, borderColor: colors.border, borderRadius: radius.lg, padding: 14 }, optionText: { fontSize: 15, fontWeight: "500", textAlign: "center" },
  optionSelected: { backgroundColor: colors.accentSoft, borderColor: colors.accentPressed }, multiConfirm: { width: "100%", minHeight: 48, borderRadius: radius.lg, backgroundColor: colors.accent, alignItems: "center", justifyContent: "center" },
  review: { gap: 9 }, reviewTitle: { fontSize: 16, fontWeight: "600", color: colors.textPrimary, paddingHorizontal: 2 }, addressHint: { fontSize: 12, color: colors.textSecondary, paddingHorizontal: 2 }, addressField: { position: "relative", zIndex: 20 }, addressSpinner: { position: "absolute", right: 15, top: 15 }, addressError: { fontSize: 12, lineHeight: 17, color: colors.warning, paddingHorizontal: 2 }, reviewInput: { minHeight: 50, borderRadius: radius.md, backgroundColor: colors.surfaceSecondary, paddingHorizontal: 15, paddingRight: 45, fontSize: 15, color: colors.textPrimary }, publish: { minHeight: 54, borderRadius: radius.lg, backgroundColor: colors.accent, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 9 }, publishText: { fontSize: 16, fontWeight: "600", color: colors.textPrimary },
  photoButton: { minHeight: 50, flex: 1, borderRadius: radius.lg, backgroundColor: colors.accent, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 },
  photoButtonText: { color: colors.textPrimary, fontSize: 15, fontWeight: "600" }, skipButton: { minHeight: 50, justifyContent: "center", paddingHorizontal: 18 }, skipInline: { alignSelf: "center", padding: 10 }, skipText: { color: colors.textSecondary, fontSize: 14, fontWeight: "500" },
  suggestions: { position: "absolute", left: 0, right: 0, bottom: 56, maxHeight: 250, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, overflow: "hidden", zIndex: 30, elevation: 12, shadowColor: "#000", shadowOpacity: 0.08, shadowRadius: 12, shadowOffset: { width: 0, height: 5 } }, suggestion: { minHeight: 48, flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 13, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colors.divider }, suggestionText: { flex: 1, fontSize: 13, lineHeight: 17, color: colors.textPrimary }, confirmed: { color: colors.success, fontSize: 13, fontWeight: "600" },
  budgetTabs: { flexDirection: "row", gap: 6 }, budgetTab: { flex: 1, minHeight: 42, borderRadius: radius.md, backgroundColor: colors.surfaceSecondary, alignItems: "center", justifyContent: "center", paddingHorizontal: 4 }, budgetTabActive: { backgroundColor: colors.accentSoft, borderWidth: 1, borderColor: colors.accentPressed }, budgetTabText: { fontSize: 11, fontWeight: "600", color: colors.textPrimary, textAlign: "center" }, rangeRow: { flexDirection: "row", gap: 8 }, rangeInput: { flex: 1 },
});
